<template>
    <div id="main-content" class="text-wrapper">
        ...
        <p class="mb-3">
            Here, you’ll find a collection of materials developed during the
            creation of this website, which may be useful for research or
            personal interest.
        </p>
        <p class="mb-3">
        ...
        <p class="mb-3">
            Scotland's Accused Witches Project page on wikidata. This includes a
        ...
        <p class="mb-3">
            ...
            >
                GitHub repository</a
            >
            of this website can be cloned and then run locally on your device.
            If you would like to contribute to this site, we welcome any pull
            requests and will endeavour to review them as soon as possible.
        </p>
        <h2>User Guide</h2>
