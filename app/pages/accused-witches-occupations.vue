<template>
    <div>
        <div id="main-content" class="pl-5 pr-5 pt-3 pb-3">
            ...
            <div>
                These bubble charts show the different occupations recorded for
                the accused witches from within the database using the Wikidata
                Query Service. There is no occupation recorded for most of the
                witches listed in the Survey, for two reasons. The first reason
                is that for many of the witches we have only limited information
                of any kind about them. The second and more interesting reason
                concerns the way in which occupations were understood. Most
                people in early modern Scotland were not known as having a
                distinct occupation, because most people, most of the time, were
                engaged in farming. It would have been meaningless to call
                someone a farmer. But it was also meaningless to designate
                someone as having an occupation other than farmer unless that
                was recognisably their main occupation. And some people had
                several occupations.
                <strong
                    >The first bubble chart includes people with no recorded
                    occupation while the second chart only includes the recorded
                    occupations.</strong
                >
            </div>
