<template>
    <div id="main-content" class="text-wrapper">
        ...
        <p class="text-justify">
            ...
            >, a lecturer in Scottish History and Project Director of the Survey
            of Scottish Witchcraft, along with Ellie Whitehead, Assistant
            Wikimedian in Residence and and MScR researcher at the University of
            Edinburgh, is highly recommended for anyone seeking to learn more
            about history of the Scottish witch trials.
        </p>
        <div
