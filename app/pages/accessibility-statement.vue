<template>
    <main id="main-content" class="text-wrapper">
        ...
        <p>
            ...
            If you find any problems not listed on this page or think we are not
            meeting accessibility requirements, contact the
            <a :href="`mailto:${supportEmail}`" class="link"
        ...
        <p>
            The University is committed to making websites accessible, in
        ...
        <p>
            ...
            Accessibility Guidelines 2.1 AA standard, due to the non-compliances
            listed below.
        </p>
        ...
        <p>
            The following items do not comply with the WCAG 2.1 AA success
            criteria
        </p>
        <ul class="ml-5 mb-3">
            <li class="list-disc">
        ...
        <p>
            We will be looking at making sure that this website complies in the
            near future.
        </p>
        ...
        <p>
            This website was last tested on 08/02/2021. The test was carried out
            by the Digital Learning Applications and Media Team.
        </p>
        <p>
            This involved manual testing of a number of sample pages. We also
            ran axe and wave automated tests on a number of sample pages.
        </p>
    </main>
</template>
